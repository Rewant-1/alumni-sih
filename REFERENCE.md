...
> ⚠️ **Not Implemented Yet: will be done soon dont build**  No geographic data is stored in the Alumni model.
...
/app
  ...
  /messages              # Chat interface *** Websocket ye sab bhi chahiye hoga ismein so plz take a look
  ...
  and i feel ek referral ka bhi hona chahiye jahan pe aap job ke liye referral maang sakte ho
```
