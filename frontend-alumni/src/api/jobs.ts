...
const MOCK_JOBS: Job[] = [
  {
    ...
    salaryMin: 2500000,
    salaryMax: 3500000,
    description: 'We are looking for a senior software engineer to join our team. You will be responsible for designing and implementing scalable web applications.',
    requirements: [
  ...
  },
  {
    ...
    salaryMin: 3000000,
    salaryMax: 4000000,
    description: 'Lead product development for our cloud services team. Define product strategy and work closely with engineering teams.',
    requirements: [
  ...
  },
  {
    ...
    type: 'Full-time',
    salary: '₹15-25 LPA',
    description: 'Design user experiences for our food delivery platform. Conduct user research and create intuitive interfaces.',
    requirements: [
  ...
  },
  {
    ...
    type: 'Internship',
    salary: '₹50K/month',
    description: 'Join our frontend team and learn from industry experts. Work on real projects impacting millions of users.',
    requirements: [
...
export const getMyJobPostings = async (): Promise<Job[]> => {
  try {
    const response = await apiClient.get<ApiResponse<Job[]>>('/jobs/my-postings');
    return response.data.data;
  } catch (error) {
